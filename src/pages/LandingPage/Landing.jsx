  ...
  return (
    <div className={styles['landing-container']}>
      ...
      <header className={styles.container}>
        <img src="/net.svg" alt="Netflix Logo" className={styles['logo']} />
        <div className={styles['btns']}>
          <div className={styles['language-select-wrapper']}>
            <div id="border-box" className={styles['border-box']}>
              <svg className={styles["language-icon"]} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
        ...
        <div className={styles.page1}>
          ...
          <div className={styles.text} id="text">
            ...
            <div id="email-form" className={styles['up-email-form']}>
              <input type="email" placeholder="Email address" id="email-one" className={styles.emailInput}/>
      ...
      <section className={styles['section2']}>
        ...
        <div className={styles['trending-section']}>
          ...
          <div className={styles['movie-carousel']}>
            <button className={`${styles.scrollButton} ${styles.left}`} onClick={() => scrollMovies('left')}>&#8249;</button>
            
            <div className={styles['movies-container']}>
              {[...Array(10)].map((_, i) => (
                <div className={styles['movie-card']} key={i}>
                  <div className={styles['movie-number']}>{i + 1}</div>
                  <img src={`/movie${i + 1}.webp`} alt={`Movie ${i + 1}`} />
                </div>
              ))}
            </div>
            
            <button className={`${styles.scrollButton} ${styles.right}`} onClick={() => scrollMovies('right')}>&#8250;</button>
          </div>
        </div>
              ...
              <div className={styles['icon-container']}>
                  <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
                    <g id="television-core-small">
                        ...
                        <path id="Vector_5" fillRule="evenodd" clipRule="evenodd" d="M8.99995 12.6H63C63.663 12.6 64.2 13.1372 64.2 13.8V50.4H7.79995V13.8C7.79995 13.1372 8.33719 12.6 8.99995 12.6ZM7.19995 50.4V13.8C7.19995 12.8059 8.00581 12 8.99995 12H63C63.9942 12 64.8 12.8059 64.8 13.8V50.4V51.6C64.8 52.5941 63.9942 53.4 63 53.4H8.99995C8.00581 53.4 7.19995 52.5941 7.19995 51.6V50.4Z" fill="url(#paint4_radial_5179_1308)"></path>
              ...
              <div className={styles['icon-container']}>
                <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
                    <g id="download-core-small">
                        ...
                        <path id="Vector_7" opacity="0.4" fillRule="evenodd" clipRule="evenodd"
      ...
      <section className={styles['faq-section']}>
        ...
        <div className={styles['faq-container']}>
          {faqs.map((faq, index) => (
            <div key={index} className={styles['faq-item-wrapper']}>
              <button 
                className={`${styles['faq-question']} ${activeFaq === index ? styles['active'] : ''}`}
        ...
        <div className={styles['footer-container']}>
          <div className={styles['ready-section']}>
            <p className={styles['ready-text']}>Ready to watch? Enter your email to create or restart your membership.</p>
            <div className={styles['email-form']}>
              <input type="email" placeholder="Email address" className={styles['email-input']}/>
          ...
          <div className={styles['footer']}>
            <div className={styles['footer-top']}>
              <p className={styles['questionsP']}>Questions? Call <a href="tel:000-800-919-1694">000-800-919-1694</a></p>
            </div>
            
            <div className={styles['footer-links']}>
              <ul className={`${styles.linkColumn} ${styles.faqChal}`} id='Faq-chal'>
              ...
              <ul className={styles['link-column']} style={{display:"flex", flexDirection:"column"}}>
            ...
            <div className={styles['language-selector']}>
              <svg className={styles['language-icon-foot']} viewBox="0 0 24 24">
