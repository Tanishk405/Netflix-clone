  ...
  return (
    <div className="landing-container">
      ...
      <header className="container">
        <img src="/net.svg" alt="Netflix Logo" className="logo" />
        <div className="btns">
          <div className="language-select-wrapper">
            <div id="border-box">
              <svg className="language-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      ...
      <section className="hero-section">
        <div className="page1">
          ...
          <div id="text">
            ...
            <div id="email-form">
              <input type="email" placeholder="Email address" id="email-one" />
              <button id="get-start-btn">
      ...
      <section className="section2">
        <div className="default-ltr-cache-dulgtd" id="line-box">
        ...
        <div className="trending-section">
          ...
          <div className="movie-carousel">
            <button className="scroll-button left" onClick={() => scrollMovies('left')}>&#8249;</button>
            ...
            <button className="scroll-button right" onClick={() => scrollMovies('right')}>&#8250;</button>
          </div>
        </div>
        ...
        <div className="footer-container">
          ...
          <div className="footer">
            <div className="footer-top">
              <p className="questions">Questions? Call <a href="tel:000-800-919-1694">000-800-919-1694</a></p>
            </div>
            
            <div className="footer-links">
              <ul className="link-column oq" style={{display:"flex", flexDirection:"column"}}>
                <li><a href="#">FAQ</a></li>
              ...
              <ul className="link-column" style={{display:"flex", flexDirection:"column"}}>
